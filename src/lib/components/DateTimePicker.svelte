    ...
    <div class="date-picker-container bg-white rounded-lg shadow-sm border border-gray-200 p-5 transition-all duration-200">
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div class="date-field">
          <label for="date-input" class="flex items-center text-sm font-medium text-gray-700 mb-1">
        ...
        <div class="time-field">
          <label for="time-input" class="flex items-center text-sm font-medium text-gray-700 mb-1">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1 text-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
