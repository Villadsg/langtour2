    ...
    <div class="flex items-center justify-between">
      ...
      {#if location}
        <button
          ...
          class="px-3 py-1.5 bg-slate-700 text-white text-sm rounded hover:bg-slate-800 transition-colors"
        >
          Confirm
        </button>
      {/if}
  ...
  {#if location}
    <div class="p-3 bg-white border-t border-slate-200">
      <div class="flex items-start gap-2">
        <svg class="w-4 h-4 text-slate-500 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
