...
<div class="bg-white shadow-md rounded-lg p-6">
    ...
    <div class="flex items-center justify-between">
        <button
            ...
            class="bg-green-100 hover:bg-green-200 text-green-700 border border-green-200 font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline flex items-center"
        ...
        <button
            ...
            class="bg-slate-100 hover:bg-slate-200 text-slate-700 border border-slate-200 font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline"
            disabled={isSubmitting}
        >
            Cancel
        </button>
