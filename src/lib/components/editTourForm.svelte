...
<div class="bg-white border border-slate-200 rounded-lg p-6">
    ...
    <div class="mb-6 grid grid-cols-1 gap-4">
        <div>
            <label for="tour-name" class="block text-sm font-medium text-slate-700 mb-1">Tour Name</label>
            <input
                id="tour-name"
                type="text"
                bind:value={name}
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
                <label for="tour-type" class="block text-sm font-medium text-slate-700 mb-1">Tour Type <span class="text-red-500">*</span></label>
                <select
                    id="tour-type"
                    bind:value={tourType}
                    class="block w-full p-3 text-slate-700 border border-slate-200 bg-white focus:ring-2 focus:ring-green-400 rounded-lg"
