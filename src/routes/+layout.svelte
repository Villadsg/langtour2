	...
	<footer class="bg-gradient-to-b from-slate-800 to-slate-900 text-white py-12 border-t border-slate-700">
		<div class="container mx-auto px-6">
			<div class="grid grid-cols-1 md:grid-cols-3 gap-10">
				...
				<div>
					<h3 class="text-sm font-medium uppercase tracking-wider mb-4 text-slate-300">Resources</h3>
					<ul class="space-y-2">
				...
				<div>
					<h3 class="text-sm font-medium uppercase tracking-wider mb-4 text-slate-300">Legal</h3>
					<ul class="space-y-2">
						<li><a href="/terms" class="text-slate-400 hover:text-white text-sm transition-colors duration-150">Terms of Service</a></li>
						<li><a href="/privacy" class="text-slate-400 hover:text-white text-sm transition-colors duration-150">Privacy Policy</a></li>
						<li><a href="/contact" class="text-slate-400 hover:text-white text-sm transition-colors duration-150">Contact Us</a></li>
					</ul>
				</div>
			</div>
			...
			<div class="border-t border-slate-800 mt-10 pt-6 flex flex-col md:flex-row justify-between items-center">
				...
				<div class="flex space-x-4 mt-4 md:mt-0">
					...
					<a href="https://facebook.com" class="text-slate-400 hover:text-white transition-colors duration-150">
						<span class="sr-only">Facebook</span>
						<svg class="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
							<path fill-rule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clip-rule="evenodd" />
						</svg>
					</a>
					<a href="https://instagram.com" class="text-slate-400 hover:text-white transition-colors duration-150">
