...
<div class={`${gradients.hero} ${text.primary} pt-20 pb-12`}>
	<div class="container mx-auto px-6">
		<div class="max-w-4xl mx-auto text-center">
			<h1 class={typography.heading.h1 + " mb-5"}>Language learning city trails</h1>
			...
			<div class="grid md:grid-cols-2 gap-3 md:gap-6 mt-8">
				<FeatureCard 
					...
					description="Improve your language skills from the preparation material and the bilingual trail guide, while exploring the city"
				/>
				
				<FeatureCard 
					icon="<svg xmlns='http://www.w3.org/2000/svg' class='h-6 w-6' fill='none' viewBox='0 0 24 24' stroke='currentColor'><path stroke-linecap='round' stroke-linejoin='round' stroke-width='1.5' d='M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253' /></svg>"
					title="Become a Language Guide"
					description="Create your own language trails and share your expertise with others while earning income."
				/>
			</div>
...
<Section variant="muted">
	<div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6">
		<div>
			<h2 class={`${typography.heading.h2} ${text.primary} mb-2`}>Available Trails</h2>
		...
		<div class="bg-amber-50 border-l-4 border-amber-400 text-amber-800 px-6 py-4 mb-8" role="alert">
			<div class="flex">
				...
				<div class="ml-3">
					...
					<p class="text-sm mt-1">Using local trail data instead. Trails created in the admin panel may not be visible.</p>
				</div>
			</div>
		</div>
	{/if}
		...
		<div class="max-w-4xl mx-auto">
			...
			<div class="relative mb-4">
				...
				<input 
					...
					placeholder="Search by city, language, or trail name..."
				/>
			</div>
	...
	<div class="grid grid-cols-1 md:grid-cols-2 gap-8">
		...
		{:else}
			<div class="col-span-full border border-slate-200 p-10 text-center bg-white">
				<p class={text.secondary}>No trails found matching your search. Try a different search term.</p>
			</div>
		{/if}
	</div>
</Section>
