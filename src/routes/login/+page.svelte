    ...
    <div class="bg-white py-6 px-4 shadow sm:rounded-lg sm:px-8">
        ...
        <div>
          ...
          <div class="mt-1">
            <input
              ...
              autocomplete="email"
              bind:value={email}
              class="appearance-none block w-full px-3 py-2 border border-slate-200 rounded-lg shadow-sm placeholder-slate-400 focus:outline-none focus:ring-green-400 focus:border-green-400 sm:text-sm"
            />
            {#if emailError}
      ...
      <div class="mt-6">
        <button
          ...
          class="w-full inline-flex justify-center items-center py-2.5 px-4 border border-slate-300 rounded-lg shadow-sm bg-white text-sm font-medium text-slate-700 hover:bg-slate-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-400 disabled:opacity-50 disabled:cursor-not-allowed"
        >
          {#if googleLoading}
