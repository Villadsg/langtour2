        ...
        <div class="bg-white rounded-lg border border-slate-200 p-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    {#if $currentUser}
                        <div class="mb-6">
                            <h3 class="text-lg font-medium text-slate-700 mb-2">Rate this route:</h3>
                    ...
                    {#if guideProfile}
                        <div class="mt-6 border border-slate-200 rounded-lg p-5">
                            <h3 class="text-lg font-medium text-slate-700 mb-3">Your Route Guide</h3>
                                ...
                                <div class="flex-1 min-w-0">
                                    ...
                                    <div class="flex flex-wrap items-center gap-3 mt-1">
                                        ...
                                        {#if guideTourCount > 0}
                                            ...
                                            <span class="text-sm text-slate-500">{guideTourCount} {guideTourCount === 1 ? 'route' : 'routes'}</span>
                                        {/if}
                    ...
                    {#if getStops(tour).length > 0}
                        ...
                        <div class="mt-6">
                            <h3 class="text-lg font-medium text-slate-700 mb-2">Route Route ({stops.length} stop{stops.length !== 1 ? 's' : ''})</h3>
                            <TourStopsMap {stops} />
                        </div>
                    {/if}
                    ...
                    <div class="mt-6">
                        <h3 class="text-lg font-medium text-slate-700 mb-2">Upcoming Scheduled Routes</h3>
